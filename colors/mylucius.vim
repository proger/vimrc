...
hi Character        ctermfg=75                                     cterm=none
" numbers decimal/hex
hi Number           guifg=#70c0d8                                   gui=none
hi Number           ctermfg=84                                      cterm=none
" true, false
hi Boolean          guifg=#70c0d8                                   gui=none
hi Boolean          ctermfg=84                                      cterm=none
" float
hi Float            guifg=#70c0d8                                   gui=none
hi Float            ctermfg=84                                      cterm=none
...
hi Statement        ctermfg=156                                     cterm=none
" if, then, else
...
hi PreCondit        ctermfg=191                                     cterm=none
...
hi Delimiter        ctermfg=153                                     cterm=none
hi Braces        ctermfg=9
...
hi Todo             ctermfg=red             ctermbg=NONE            cterm=underline
" match parenthesis, brackets
hi MatchParen       guifg=#00ff00           guibg=NONE              gui=bold
hi MatchParen       ctermfg=darkblue        ctermbg=yellow            cterm=bold
...
hi CursorIM         ctermfg=bg              ctermbg=75
" cursor column
...
hi VimwikiHeader2   ctermfg=75                                     cterm=none
hi VimwikiHeader3   guifg=#b3d38c                                   gui=bold
hi VimwikiHeader3   ctermfg=154                                     cterm=none
hi VimwikiHeader4   guifg=#86c6b6                                   gui=bold 
hi VimwikiHeader4   ctermfg=75                                     cterm=none
