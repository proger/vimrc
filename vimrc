...
set noeb " don't mess with my brains
set vb t_vb=
...
augroup filetype
	...
	au FileType python\|java\|javascript\|haskell\|pyrex\|objc\|qml\|erlang setlocal expandtab
	au FileType python\|java\|javascript\|haskell\|pyrex\|objc\|qml\|erlang setlocal tabstop=4
	au FileType python\|java\|javascript\|haskell\|pyrex\|objc\|qml\|erlang setlocal shiftwidth=4
	au FileType python\|java\|javascript\|haskell\|pyrex\|objc\|qml\|erlang setlocal softtabstop=4
	au FileType python ab ipdb import pdb; pdb.set_trace()
	...
	au FileType ant\|x\=h\=t\=ml\(django\)\= setlocal expandtab
	au FileType ant\|x\=h\=t\=ml\(django\)\= setlocal tabstop=4
	au FileType ant\|x\=h\=t\=ml\(django\)\= setlocal shiftwidth=4
	au FileType ant\|x\=h\=t\=ml\(django\)\= setlocal softtabstop=4
	au FileType ant\|x\=h\=t\=ml\(django\)\= let b:delimitMate_autoclose = 0
...
function! Bdeleteonly()
    for buffer in filter(Buflist(), 'v:val != bufnr("%")')
        exec "bdelete ".buffer
    endfor
endfunction
...
map <Leader>G :FufFileWithCurrentBufferDir<CR>
map <Leader>F :FufCoverageFile<CR>
map <Leader>T :FufTag<CR>
map <Leader>B :FufBuffer<CR>

"let fuf_coveragefile_globPatterns=[\
"	'**/*.h', '**/*.c', '**/*.erl', '**/*.py',
"	'**/*akefile', '**/*.sh']
let g:fuf_coveragefile_exclude="ebin"
